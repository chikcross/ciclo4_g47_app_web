                ...
                <div className="fluid">
                    <footer className="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top bg-light">
                        ...
                        <ul className="nav col-md-4 justify-content-end list-unstyled d-flex">
                            ...
                            <li className="ms-3"><img className="bi" width="24" height="24" src={var1}/></li>
                            <li className="ms-3"><img className="bi" width="24" height="24" src={process.env.PUBLIC_URL+"./multimedia/youtube.svg"}/></li>
                            <li className="ms-3"><img className="bi" width="24" height="24" src={process.env.PUBLIC_URL+var2}/></li>
                        </ul>
                    </footer>
                </div>
            </div>
